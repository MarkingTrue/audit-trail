...
from audit_trail.cli import main
from audit_trail.models import Note, ProjectState, Task
from audit_trail.cli import demo_state
from audit_trail.storage import load_state, save_state
from audit_trail.models import generate_short_id
from audit_trail.validation import normalize_tags, require_text, validate_task_status
from audit_trail.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
